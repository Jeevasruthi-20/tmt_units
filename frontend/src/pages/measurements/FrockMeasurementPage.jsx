...
export default function FrockMeasurementPage() {
  const measurements = [
    ...
    },
    {
      name: 'Waist',
      instruction:
        'Measure around the natural waistline where the frock will fit. Keep one finger between the tape and the body.',
    },
    {
      name: 'Hip',
      instruction:
    ...
    },
    {
      name: 'Frock Length',
      instruction:
        'Measure from the shoulder (near the neck) straight down to where you want the frock to end (knee, calf or ankle).',
    },
  ];
  ...
  const formFields = [
    ...
    { name: 'frockLength', label: 'Frock Length', required: true },
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-lg">
              Follow these steps to share accurate measurements for your custom frock.
            </p>
          </div>
        </div>
      </section>
