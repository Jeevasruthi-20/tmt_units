...
export default function AnarkaliMeasurementPage() {
    const measurements = [
        ...
        },
        {
            name: 'Waist',
            instruction:
                'Measure around the natural waistline where the Anarkali will fit. Keep one finger between the tape and the body.',
        },
        {
            name: 'Hip',
            instruction:
        ...
        },
        {
            name: 'Sleeve Length',
            instruction:
                'Measure from the shoulder point to where you want the sleeve to end (short, elbow or full length).',
        },
        {
            name: 'Anarkali Length',
            instruction:
                'Measure from the shoulder (near the neck) straight down to where you want the Anarkali to end (usually floor length or ankle length).',
        },
    ];
    ...
    const formFields = [
        ...
        { name: 'anarkaliLength', label: 'Anarkali Length', required: true },
    ];
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-3xl">
                        <h1 className="font-serif font-bold text-3xl lg:text-4xl text-foreground mb-4">
                            Anarkali Measurements
                        </h1>
                        <p className="text-muted-foreground text-lg">
                            Follow these steps to share accurate measurements for your custom Anarkali.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    <div>
                        ...
                        <img
                            ...
                            alt="Anarkali measurement guide"
